...
- [S3 lifecycle vs persistência](feedback_s3_lifecycle_collision.md) — bucket tem lifecycle 7d em uploads/; ativos persistentes (imagens displayable de exames) devem ir pra exam-images/ ou outro prefix sem lifecycle (incidente 2026-05-04 — exames perderam imagens com markers depois de 7 dias)
