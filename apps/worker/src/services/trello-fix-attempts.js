 ...
 *
 * DUPLICATA controlada de apps/api/src/services/trello-fix-attempts.js.
 * API e Worker rodam em containers Docker separados (sem filesystem
 * compartilhado), e o monorepo build copia só `apps/<app>/src` pra cada
 * container. Por isso o serviço existe em ambos os apps. Se editar um,
 * editar o outro (sincronizado manualmente). Tests cobrem o lado API
 * (apps/api/tests/services/trello-fix-attempts.test.js); este lado é
 * pure-copy idêntico.
 *
